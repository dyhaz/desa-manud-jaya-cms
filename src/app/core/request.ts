...
import { ApiError } from '@core/http/api/core/ApiError';
import type { ApiRequestOptions } from '@core/http/api/core/ApiRequestOptions';
import type { ApiResult } from '@core/http/api/core/ApiResult';
import type { OpenAPIConfig } from '@core/http/api/core/OpenAPI';
...
export const request = <T>(config: OpenAPIConfig, http: HttpClient, options: ApiRequestOptions): Observable<T> => {
    config.BASE = environment.apiConfig.baseUrl;
